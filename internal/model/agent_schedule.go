...
type AgentSchedule struct {
	...
	AgentID   uuid.UUID  `gorm:"type:uuid;not null;uniqueIndex:idx_agent_schedule_agent_runtime"`
...
type AgentScheduleRun struct {
	...
	RunKey       string     `gorm:"not null;size:500;uniqueIndex:idx_agent_schedule_run_key"`
...
func (AgentScheduleRun) TableName() string { return "agent_schedule_runs" }
