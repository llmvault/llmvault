...
type Session struct {
	...
	SandboxVCPU                 int        `gorm:"column:sandbox_vcpu;not null;default:1"`
	SandboxPricingVersion       int        `gorm:"not null;default:1"`
	SandboxCreditsPerVCPUMinute int        `gorm:"column:sandbox_credits_per_vcpu_minute;not null;default:1"`
