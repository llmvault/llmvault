	...
	{ // crof — CrofAI
		...
		Models: map[string]Model{
			"deepseek-v4-pro": {
				...
				Description:      "Crof-distilled DeepSeek V4 Pro for cheaper complex coding tasks.",
				Modalities: &Modalities{
					Input:  []string{"text"},
					Output: []string{"text"},
				},
			...
			"deepseek-v4-flash": {
				...
				Knowledge:        "2025-05",
				ReleaseDate:      "2026-04-24",
				Description:      "Crof-distilled DeepSeek V4 Flash for cheap day-to-day agent work.",
				Modalities: &Modalities{
					Input:  []string{"text"},
					Output: []string{"text"},
				},
			...
			"mimo-v2.5-pro": {
				...
				Description:      "Crof-distilled MiMo for long-context reasoning and multi-step tasks.",
				Modalities: &Modalities{
					Input:  []string{"text"},
					Output: []string{"text"},
				},
			...
			"glm-5.2": {
				...
				Description:      "Crof-distilled GLM-5.2 with a large context window.",
				Modalities: &Modalities{
					Input:  []string{"text"},
					Output: []string{"text"},
				},
			...
			"kimi-k2.7-code": {
				...
				Description:      "Crof-distilled Kimi code model for coding-heavy workflows.",
				Modalities: &Modalities{
