	...
	{ // openrouter — OpenRouter
		...
		Models: map[string]Model{
			...
			"openai/gpt-5.6-luna-pro": {
				...
				Description:      "Use for fast, cost-efficient work when higher reasoning is needed.",
				Modalities: &Modalities{
					Input:  []string{"text", "image", "file"},
					Output: []string{"text"},
				},
				Cost: &Cost{
					Input:      1,
			...
			"openai/gpt-5.6-terra-pro": {
				...
				StructuredOutput: true,
				ReleaseDate:      "2026-07-09",
				Description:      "Use for everyday coding and reasoning when higher reasoning is needed.",
				Modalities: &Modalities{
					Input:  []string{"text", "image", "file"},
					Output: []string{"text"},
				},
			...
			"openai/gpt-5.6-sol-pro": {
				...
				StructuredOutput: true,
				ReleaseDate:      "2026-07-09",
				Description:      "Use for complex coding and reasoning when higher reasoning is needed.",
				Modalities: &Modalities{
					Input:  []string{"text", "image", "file"},
					Output: []string{"text"},
				},
