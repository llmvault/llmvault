...
func TestEmployeeTriggerDispatchHandler_GitHubCheckSuiteMissingPullRequestSkips(t *testing.T) {
...
func TestEmployeeTriggerDispatchHandler_GitHubCheckSuiteMissingDependenciesErrors(t *testing.T) {
	handler := &EmployeeTriggerDispatchHandler{}
	_, _, err := handler.shouldSkipTriggerDelivery(t.Context(), EmployeeTriggerDispatchPayload{
		Provider:    "github-app",
		EventType:   "check_suite",
		EventAction: "completed",
...
func TestEmployeeTriggerDispatchHandler_NonCheckSuiteEventsPassThrough(t *testing.T) {
	handler := &EmployeeTriggerDispatchHandler{}
	skip, reason, err := handler.shouldSkipTriggerDelivery(t.Context(), EmployeeTriggerDispatchPayload{
		Provider:    "github-app",
...
func TestEmployeeTriggerDispatchHandler_GitHubCheckSuiteUsesPullRequestAuthor(t *testing.T) {
...
func TestEmployeeTriggerDispatchHandler_GitHubCheckSuiteSkipsNonHivyPullRequestAuthor(t *testing.T) {
	db := openTasksMemoryTestDB(t)
	orgID := uuid.New()
	connID := uuid.New()
