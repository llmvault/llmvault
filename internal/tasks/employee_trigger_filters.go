...
func (h *EmployeeTriggerDispatchHandler) shouldSkipTriggerDelivery(ctx context.Context, payload EmployeeTriggerDispatchPayload, webhookPayload map[string]any) (bool, string, error) {
...
func isGitHubCheckSuiteCompleted(payload EmployeeTriggerDispatchPayload) bool {
...
func (h *EmployeeTriggerDispatchHandler) githubCheckSuitePullRequestCreatedByHivy(ctx context.Context, payload EmployeeTriggerDispatchPayload, webhookPayload map[string]any) (bool, error) {
