...
func NewAgentCleanupHandler(db *gorm.DB, orchestrator *sandbox.Orchestrator) *AgentCleanupHandler {
	return &AgentCleanupHandler{db: db, orchestrator: orchestrator}
}
