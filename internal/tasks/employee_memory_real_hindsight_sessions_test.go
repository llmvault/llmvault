...
func productionMemorySessions() []productionSession {
	return []productionSession{
		...
		{user: "Daniel", text: "Employee runtime changes need integration tests. Unit tests alone are not enough there.", tools: []string{"bash: ran go test ./internal/agentruntime", "edit_file: added compile integration coverage"}, reply: "Added integration coverage for employee runtime compile.", noise: []string{"ship it maybe"}},
