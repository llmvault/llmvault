...
type agentSkillSyncPayload struct {
...
func (h *AgentOutboundWebhookHandler) syncSkillEvent(ctx context.Context, sb *model.Sandbox, raw map[string]any) error {
	...
	var payload agentSkillSyncPayload
...
func (h *AgentOutboundWebhookHandler) detachSyncedSkill(ctx context.Context, orgID, agentID uuid.UUID, slug string) error {
...
func (h *AgentOutboundWebhookHandler) upsertSyncedSkill(ctx context.Context, orgID, agentID uuid.UUID, slug string, payload agentSkillSyncPayload) error {
