...
func (h *agentHarness) createOrg(t *testing.T) orgWithMember {
	return h.createOrgWithRole(t, "admin")
}

func (h *agentHarness) createOrgWithRole(t *testing.T, role string) orgWithMember {
	t.Helper()
...
func (h *agentHarness) seedSystemCred(t *testing.T, providerID string, revoked bool) model.Credential {
	t.Helper()
...
func (h *agentHarness) post(t *testing.T, m orgWithMember, body any) *httptest.ResponseRecorder {
	return h.postAs(t, m, body, "admin")
}

func (h *agentHarness) postAs(t *testing.T, m orgWithMember, body any, role string) *httptest.ResponseRecorder {
	t.Helper()
...
func decodeAgentResp(t *testing.T, rr *httptest.ResponseRecorder) map[string]string {
	t.Helper()
...
func (h *agentHarness) seedGlobalSkill(t *testing.T, name, status string) model.Skill {
	t.Helper()
	skill := model.Skill{
...
func validAgentBody() map[string]any {
