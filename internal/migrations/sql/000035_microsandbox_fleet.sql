...
-- +goose Down
DROP TABLE IF EXISTS microsandbox_events;
DROP TABLE IF EXISTS microsandbox_snapshots;
DROP TABLE IF EXISTS microsandbox_sandbox_ports;
DROP TABLE IF EXISTS microsandbox_sandboxes;
DROP TABLE IF EXISTS microsandbox_org_preview_secrets;
DROP TABLE IF EXISTS microsandbox_runners;
