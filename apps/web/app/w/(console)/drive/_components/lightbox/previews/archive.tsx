...
export function ArchivePreview({
  ...
  return (
    <div className="flex h-full w-full items-center justify-center px-6 py-24">
      <div className="relative flex w-full max-w-[520px] flex-col items-center gap-6 overflow-hidden rounded-2xl bg-card px-10 py-12 text-center shadow-sm ring-1 ring-border">
        ...
        <div className="relative flex flex-col gap-1.5">
          ...
          <h3 className="font-heading text-[20px] leading-tight font-medium text-foreground">
            {asset.filename}
          </h3>
