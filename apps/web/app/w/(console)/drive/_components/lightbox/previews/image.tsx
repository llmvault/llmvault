    ...
    >
      ...
      <div className="relative max-h-full max-w-full">
        ...
        <img
          ...
          alt={asset.filename}
          draggable={false}
          className="block max-h-[calc(100vh-9rem)] max-w-[min(1200px,calc(100vw-6rem))] rounded-md object-contain transition-transform duration-300 ease-[cubic-bezier(0.16,1,0.3,1)] select-none"
          style={{
