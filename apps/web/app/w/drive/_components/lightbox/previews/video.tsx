...
export function VideoPreview({ asset }: { asset: Asset }) {
  return (
    <div className="flex h-full w-full items-center justify-center px-12 py-20">
      <div
        className="relative w-full max-w-[min(1200px,calc(100vw-6rem))] overflow-hidden rounded-md bg-card shadow-xl ring-1 shadow-foreground/[0.04] ring-border"
        ...
        style={{
          ...
          ["--media-focus-ring" as never]:
            "0 0 0 3px oklch(var(--ring) / 0.35)",
        }}
      >
        <MediaPlayer
