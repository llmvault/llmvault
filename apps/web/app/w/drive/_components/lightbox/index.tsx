  ...
  return (
    <DialogPrimitive.Root open={open} onOpenChange={(o) => !o && onClose()}>
      <DialogPrimitive.Portal>
        <DialogPrimitive.Backdrop className="fixed inset-0 z-[60] bg-background/95 supports-backdrop-filter:bg-background/70 supports-backdrop-filter:backdrop-blur-xl data-open:animate-in data-open:duration-200 data-open:fade-in-0 data-closed:animate-out data-closed:fade-out-0" />
      ...
      {visible ? (
        ...
        >
          <div className="flex min-w-0 flex-1 flex-col gap-0.5">
            <h2 className="truncate font-heading text-[15px] leading-tight font-medium text-foreground">
              {filename}
            </h2>
          ...
          <span className="hidden font-mono text-[10.5px] tracking-[0.04em] text-muted-foreground tabular-nums sm:inline">
            {index + 1} <span className="text-muted-foreground/50">/</span>{" "}
            {total}
          </span>
