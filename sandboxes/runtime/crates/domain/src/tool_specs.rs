    ...
    vec![
        ToolSpec::Bash(BashConfig {
            ...
            env_passthrough: vec![
                ...
                "TMP".into(),
                "DOCKER_TMPDIR".into(),
                "PENPOT_CANVAS_URL".into(),
                "PENPOT_CANVAS_TEAM_ID".into(),
                "PENPOT_CANVAS_PROFILE_ID".into(),
                "PENPOT_CANVAS_SESSION_JWT".into(),
                "PENPOT_CANVAS_MCP_URL".into(),
...
mod tests {
    ...
    fn default_bash_env_passthrough_keeps_storage_defaults() {
        ...
        for key in [
            ...
            "DOCKER_TMPDIR",
            "PENPOT_CANVAS_URL",
            "PENPOT_CANVAS_TEAM_ID",
            "PENPOT_CANVAS_PROFILE_ID",
            "PENPOT_CANVAS_SESSION_JWT",
            "PENPOT_CANVAS_MCP_URL",
