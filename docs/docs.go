...
const docTemplate = `{
    ...
    "paths": {
                ...
                "responses": {
                    "200": {
                        ...
                        "schema": {
                            "type": "array",
                            "items": {
                                "$ref": "#/definitions/gatewayRouteResponse"
                            }
                        }
                    }
                }
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/createGatewayRouteRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/agents/{id}/gateway-routes/{routeID}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/updateGatewayRouteRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/v1/agents/{id}/gateway-routes/{routeID}/rotate-secret": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/paginatedResponse-handler_agentSessionResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/agents/{id}/sessions/messages": {
            "post": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/sendAgentSessionMessageRequest"
                        }
                    }
                ],
                "responses": {
                    "202": {
                        "description": "Accepted",
                        "schema": {
                            "$ref": "#/definitions/sendAgentSessionMessageResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/agents/{id}/sessions/{sessionID}/events": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/paginatedResponse-handler_agentSessionEventResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/agents/{id}/sessions/{sessionID}/streams/{streamID}": {
            "get": {
                "security": [
                    {
                        "BearerAuth": []
    ...
    "definitions": {
        ...
        "paginatedResponse-handler_agentSessionEventResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/agentSessionEventResponse"
                    }
                },
                "has_more": {
                    "type": "boolean"
        ...
        "paginatedResponse-handler_agentSessionResponse": {
            "type": "object",
            "properties": {
                "data": {
                    "type": "array",
