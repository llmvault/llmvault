            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/agentEnvironmentVariablesResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "patch": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/updateAgentEnvironmentVariableRequest"
                        }
                    }
                ],
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/agentEnvironmentVariableMutationResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/agentInboxResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "responses": {
                    "201": {
                        "description": "Created",
                        "schema": {
                            "$ref": "#/definitions/memoryMutationResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/v1/sessions/{id}/stream": {
            "get": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "integer",
                        "description": "Replay events after this runtime sequence",
                        "name": "after_seq",
                        "in": "query"
                    },
                    {
                        "type": "string",
                        "description": "Replay from this turn ID",
                        "name": "from_turn_id",
                        "in": "query"
                    },
                    {
                        "type": "boolean",
                        "description": "Continue following after replaying a turn",
                        "name": "follow",
                        "in": "query"
                    }
                ],
        ...
        "agentEnvironmentVariableMutationResponse": {
            ...
            "properties": {
                "environment_variable": {
                    "$ref": "#/definitions/agentEnvironmentVariableResponse"
                }
            }
        },
