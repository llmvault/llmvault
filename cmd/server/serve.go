...
func runServe(ctx context.Context, deps *bootstrap.Deps, enqueuer enqueue.TaskEnqueuer) error {
	...
	setupPublicRoutes(r, cfg, database, redisClient, h.providerHandler, h.integrationHandler, actionsCatalog, h.orgInviteHandler, h.plansHandler, h.nangoWebhookHandler, h.incomingWebhookHandler, nangoClient, sandboxEncKey, deps.KMS, h.uploadsHandler, h.imageDescribeHandler, h.canvasHandler, orchestrator, orchestratorMissing)
