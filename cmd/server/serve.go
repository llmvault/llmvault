...
func runServe(ctx context.Context, deps *bootstrap.Deps, enqueuer enqueue.TaskEnqueuer) error {
	...
	setupPublicRoutes(r, cfg, database, redisClient, h.providerHandler, h.integrationHandler, actionsCatalog, h.orgInviteHandler, h.nangoWebhookHandler, h.incomingWebhookHandler, h.resendWebhookHandler, nangoClient, sandboxEncKey, deps.KMS, h.uploadsHandler, h.imageDescribeHandler, h.canvasHandler, h.appsInternalHandler, orchestrator, orchestratorMissing, deps.Purchases)
