...
# Helm's namespace is release context only: charts may still render resources
# without metadata.namespace. Passing the output through Kustomize makes the
# manifest safe to apply directly and pins the chart-selected image by digest.
