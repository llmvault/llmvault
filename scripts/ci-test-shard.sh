...
internal_core_shard_packages() {
  ...
  case "$shard_index" in
    ...
    4) select_internal_core_packages bridge bridgeevents proxy streaming slackapp slackworkflow providerauth providerheaders ;;
    ...
    11) select_internal_core_packages evals observability/correlation observability/metrics observability/sentry observe sheets ;;
    *)
