...
For a review without inline comments, use `gh pr review <number> --approve|--comment|--request-changes --body "..."`.
...
The review on GitHub is the deliverable. Post a short status only when it adds useful context, then wait for the next delivered event.
