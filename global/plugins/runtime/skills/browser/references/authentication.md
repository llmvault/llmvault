...
```bash
browser --session-name myapp state load ./my-auth.json
...
browser --session-name twitter open https://twitter.com
# ... login flow ...
browser close  # state saved to ~/.browser/sessions/
...
browser --session-name secure open https://app.example.com
```
